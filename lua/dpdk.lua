...
-- Link speeds (rte_ethdev.h)
mod.ETH_LINK_SPEED_AUTONEG  = bit.lshift(0, 0)
mod.ETH_LINK_SPEED_FIXED    = bit.lshift(1, 0)
mod.ETH_LINK_SPEED_10M_HD   = bit.lshift(1, 1)
mod.ETH_LINK_SPEED_10M      = bit.lshift(1, 2)
mod.ETH_LINK_SPEED_100M_HD  = bit.lshift(1, 3)
mod.ETH_LINK_SPEED_100M     = bit.lshift(1, 4)
mod.ETH_LINK_SPEED_1G       = bit.lshift(1, 5)
mod.ETH_LINK_SPEED_2_5G     = bit.lshift(1, 6)
mod.ETH_LINK_SPEED_5G       = bit.lshift(1, 7)
mod.ETH_LINK_SPEED_10G      = bit.lshift(1, 8)
mod.ETH_LINK_SPEED_20G      = bit.lshift(1, 9)
mod.ETH_LINK_SPEED_25G      = bit.lshift(1, 10)
mod.ETH_LINK_SPEED_40G      = bit.lshift(1, 11)
mod.ETH_LINK_SPEED_50G      = bit.lshift(1, 12)
mod.ETH_LINK_SPEED_56G      = bit.lshift(1, 13)
mod.ETH_LINK_SPEED_100G     = bit.lshift(1, 14)
mod.ETH_LINK_SPEED_200G     = bit.lshift(1, 15)
